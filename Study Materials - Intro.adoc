...
. link:JT/04_build_tools_maven_gradle/Build_Tools_Maven_Gradle_README.md[Build Tools - Maven, Gradle]
...
. link:JT/07_debugging_and_run_debug_configuration/IDE_Debugger/How_to_debug.md[How to debug? IDE Debugger & Run configurations]
...
. link:JT/11_overloading_overriding/overloading_vs_overriding.md[Overriding vs. Overloading]
...
. link:TL/22_configuring_&_using_logger/Configuring & Using Logger.adoc[Configure & use logger]
